...
- **Commit format**: Follow conventional commits (e.g., `feat:`, `fix:`, `chore:`)
- **Pull requests**: Reference issue numbers and provide clear descriptions
- **Code review**: All PRs require review before merging

## Testing
- Run all tests: `mvn clean test`
- Run specific test class: `mvn test -Dtest=ClassName`
- Generate reports: `mvn allure:report` (if configured)

---

*Maintained by Puneet for Automation QA portfolio*
